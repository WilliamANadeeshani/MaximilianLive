    ...
    <html lang="en">
        ...
        <script type="text/javascript">
            ...
            function updateMcq(x) {
                var mcqId = x;
                var url = "SetTimePageView?mcqId=" + mcqId;
                ...
                request.onreadystatechange = function () {
                    if (request.readyState == 4) {
                        if (request.status == 200) {
                            window.location.href=("jsp/speaker/mcqSetTime.jsp");
                        }
                    }
                };
            }
                                        ...
                                        <tbody>
                                            <c:forEach items="${mcq}" var="mcq">
                                                <tr>
                                                    ...
                                                    <td> 
                                                        <button class="btn waves-effect waves-light" onclick="updateMcq(${mcq.getMcqId()})">Set Time</button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
